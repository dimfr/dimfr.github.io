      ...
      this.extractDataKinopubvideos = function (str) {
        ...
        data.forEach(function (element) {
          ...
          card.on('hover:enter', function () {
            ...
            /*var video = { 
                               title: element.tvtitle, 
                               url: 'https://devstreaming-cdn.apple.com/videos/streaming/examples/img_bipbop_adv_example_fmp4/master.m3u8' //element.tvmedia 
                           };
            var playlist = [], 
                           i = 1; 
                           data.forEach((function (a) { playlist.push({ title: a.tvtitle, url: a.tvmedia }), i++ })), video['iptv'] = true, video['playlist'] = playlist;
